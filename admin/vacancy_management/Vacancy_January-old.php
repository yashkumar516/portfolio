...
<ol>
    ...
    <li><b>TGT – Science :</> M.Sc in Botany / Zoology, B.Ed.</li><br>
    <li><b>PRT – Science  :</> B.Sc/M.Sc in Botany/Zoology/Physics/Chemistry, B.Ed. /2-year Diploma in Elementary Education / B.El.Ed.</li><br>
    <li><b>PRT – German  :</> B2 from Goethe Institut/ B.A. (Hons.) /M.A. in German.</li><br>
    <li><b>PGT – Hindi :</> M.A. in Hindi,  B.Ed.</li><br>
...
<ul>
  ...
  <li><b>Print of the application form along with acknowledgement slip of payment should be submitted at the school gate on any working days from 7:30 a.m. to 2:00 p.m.</b></li>
</ul>
 </div>
 <div class="link"> <a href="Instructions.php"><button class="btnmanu">CLICK HERE TO PROCEED </button></a></div>
     </div>
    </div>
    </body>
    </html>
